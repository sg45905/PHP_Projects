            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="top: 10px;">
                        <h2>Welcome to KYRA Banking Systems</h2>
                        <p></p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="images/home4.png" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block" style="top: 10px;">
                        <h2>Welcome to KYRA Banking Systems</h2>
                        <p></p>
                    </div>
        ...
        <div class="container mt-3">
            ...
            <div class="row mt-3">
                <div class="col-lg-8 col-sm-12 mt-3">
                    <img src="images/home2.png" alt="About us" style="border: 2px solid black; width: 100%; height: 100%">
                </div>
                <div class="col-lg-4 col-sm-12 mt-3">
                    <span>
                        <p style="text-align: justify;">
                            This is a demo website by <a href="https://sg45905.github.io" style="text-decoration: none;">Sarthak Gupta</a> in partial fullfillment of the internship opportunity provided to me by <a href="https://www.linkedin.com/in/the-sparks-foundation/" style="text-decoration: none;">The Sparks Foudation</a>. Here you can view all the customers associated with our bank, and also you can make transfer from one customer's account to another. <br><br> This is the demo for the task #1 in Web and app designing internship domain. <br><br> Flow of the website - <br> Home Page > View All Customers > Select and View One Customer > Transfer Money > View All Customers.
                        </p>
                    </span>
                </div>
            </div>
            ...
            <div class="text-center">
                <button class="btn">
                    <a href="contact.php" style="text-decoration: none; color: #f0ffff;">Enquire Now</a>
                </button>
            </div>
        </div>
