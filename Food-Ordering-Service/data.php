<?php
    ...
    // objects of the menu items
    $juice = new Drink('JUICE', 6, 'juice.png', 'cold');
    $coffee = new Drink('COFFEE', 5, 'coffee.png', 'hot');
    $curry = new Food('CURRY', 9, 'curry.png', 3);
    $pasta = new Food('PASTA', 12, 'pasta.png', 1);
